...
function NavBar () {
  ...
  return (
    <header id='#' className='flex justify-between items-center py-5 w-[1120px] mx-auto border-b-2 border-purple-200'>
        <img style={{ width: 110, height: 30 }} src={logo} alt='Logo' />
        <nav className='flex flex-row gap-x-10 opacity-80'>
            <a href='#' className="hover:text-purple-200 text-purple-400">{language === 'es' ? 'Inicio' : 'Home'}</a>
