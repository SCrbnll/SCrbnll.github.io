    ...
    return (
        <li class="mb-10 lg:ms-10">            
            <span class=" absolute flex items-center justify-center lg:w-6 lg:h-6 w-4 h-4 bg-purple-900 rounded-full -start-3 ring-8 ring-gray-900 ">
                <svg class="lg:w-2.5 lg:h-2.5 w-2 h-2 text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <time class="block mb-2 text-sm font-normal lg:w-full w-[200px] leading-none text-orange-100 opacity-80 lg:ml-0 ml-8 ">{date}</time>
            <p class="mb-4 text-sm lg:text-lg text-wrap font-normal lg:w-full w-[250px] text-[#e3e3e3] lg:ml-0 ml-8 ">{description} </p>
        </li>
    )
}
